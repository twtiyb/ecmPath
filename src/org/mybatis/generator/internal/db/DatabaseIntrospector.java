...
public class DatabaseIntrospector {
    ...
    private Map<ActualTableName, List<IntrospectedColumn>> getColumns(
        ...
        ResultSet rs = databaseMetaData.getTables(localCatalog, localSchema,
                localTableName,  new String[]{"TABLE"});

        String tableRemrk = "";
        while (rs.next()) {
            tableRemrk = rs.getString("REMARKS");
        }

        rs = databaseMetaData.getColumns(localCatalog, localSchema,
                localTableName, null);
